    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-primary/20 via-primary/10 to-background overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[60%] bg-primary/8 rounded-full blur-[100px] animate-[drift_20s_ease-in-out_infinite]" />
          <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-primary/6 rounded-full blur-[80px] animate-[drift_25s_ease-in-out_infinite_reverse]" />
          <div className="absolute top-[40%] left-[30%] w-[40%] h-[40%] bg-primary/5 rounded-full blur-[90px] animate-[drift_18s_ease-in-out_infinite_3s]" />
        </div>
            ...
            <div className="bg-card/50 border border-border/50 rounded-xl p-4 mb-4 space-y-3">
              ...
              <div className="flex items-center justify-center gap-4 pt-2 border-t border-border/50">
                <div className="text-center">
                  <div className="text-lg font-bold text-foreground">€7.40{t("auth.perMonth")}</div>
