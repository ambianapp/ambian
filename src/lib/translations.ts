...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "help.billingPlansDesc": "We offer flexible subscription options to fit your business needs:",
    "help.billingPlanMonthly": "Monthly: €8.90/month – Pay month-to-month, cancel anytime",
    "help.billingPlanYearly": "Yearly: €89/year (€7.40/month) – Save €17.80 compared to monthly",
    ...
    "help.billingPaymentInvoice": "Invoice – Receive an invoice with 14 days to pay",
    "help.billingPaymentIBAN": "Bank Transfer (IBAN) – Pay via SEPA bank transfer (allow extra days for processing)",
    ...
    "help.billingLocationTip2": "Each location represents a separate device or speaker system",
    "help.billingCancel": "Cancellation & Refunds",
    "help.billingCancelDesc": "You can cancel your subscription anytime from Profile → Manage Subscription. Your access continues until the end of your current billing period. Refunds may be requested within 14 days of initial purchase for unused service periods.",
  ...
  sv: {
    ...
    "help.billingPlansDesc": "Vi erbjuder flexibla prenumerationsalternativ:",
    "help.billingPlanMonthly": "Månadsvis: €8.90/månad – Betala månadsvis, avsluta när som helst",
    "help.billingPlanYearly": "Årsvis: €89/år (€7.40/månad) – Spara €17.80 jämfört med månadsvis",
    ...
    "help.billingPaymentInvoice": "Faktura – Få en faktura med 14 dagars betalningstid",
    "help.billingPaymentIBAN": "Banköverföring (IBAN) – Betala via SEPA-överföring (tillåt extra dagar för behandling)",
    ...
    "help.billingLocationTip2": "Varje plats representerar en separat enhet eller högtalarsystem",
    "help.billingCancel": "Avbokning & Återbetalning",
    ...
    "help.billingPlansDesc": "Tarjoamme joustavia tilausvaihtoehtoja:",
    "help.billingPlanMonthly": "Kuukausittain: €8.90/kk – Maksa kuukausittain, peruuta milloin tahansa",
    "help.billingPlanYearly": "Vuosittain: €89/vuosi (€7.40/kk) – Säästä €17.80 verrattuna kuukausimaksuun",
    ...
    "help.billingPaymentInvoice": "Lasku – Saat laskun 14 päivän maksuajalla",
    "help.billingPaymentIBAN": "Pankkisiirto (IBAN) – Maksa SEPA-siirrolla (varaa lisäaikaa käsittelyyn)",
    ...
    "help.billingLocationTip2": "Jokainen sijainti edustaa erillistä laitetta tai kaiutinjärjestelmää",
    "help.billingCancel": "Peruutus & Hyvitykset",
  ...
  de: {
    ...
    "help.billingPlansDesc": "Wir bieten flexible Abonnement-Optionen:",
    "help.billingPlanMonthly": "Monatlich: €8.90/Monat – Monatlich zahlen, jederzeit kündigen",
    "help.billingPlanYearly": "Jährlich: €89/Jahr (€7.40/Monat) – €17.80 sparen gegenüber monatlich",
    ...
    "help.billingPaymentInvoice": "Rechnung – Erhalte eine Rechnung mit 14 Tagen Zahlungsziel",
    "help.billingPaymentIBAN": "Banküberweisung (IBAN) – Per SEPA-Überweisung zahlen (zusätzliche Bearbeitungszeit einplanen)",
    ...
    "help.billingLocationTip2": "Jeder Standort entspricht einem separaten Gerät oder Lautsprechersystem",
    "help.billingCancel": "Kündigung & Erstattung",
  ...
  fr: {
    ...
    "help.billingPlansDesc": "Nous proposons des options d'abonnement flexibles :",
    "help.billingPlanMonthly": "Mensuel : €8.90/mois – Payez mensuellement, annulez à tout moment",
    "help.billingPlanYearly": "Annuel : €89/an (€7.40/mois) – Économisez €17.80 par rapport au mensuel",
    ...
    "help.billingPaymentInvoice": "Facture – Recevez une facture avec 14 jours pour payer",
    "help.billingPaymentIBAN": "Virement bancaire (IBAN) – Payez par virement SEPA (prévoir des jours supplémentaires)",
    ...
    "help.billingLocationTip2": "Chaque emplacement représente un appareil ou système audio séparé",
    "help.billingCancel": "Annulation & Remboursements",
