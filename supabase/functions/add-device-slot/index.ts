...
const maybeCreateAndSendInvoiceForSendInvoiceSubscription = async (params: {
  ...
  // Create an invoice that includes any pending prorations generated by the subscription update.
  // (For send_invoice subscriptions, Stripe won't automatically email an "updated" invoice unless we create/send one.)
  const invoice = await stripe.invoices.create({
    ...
    auto_advance: true,
    // Stripe uses this to decide whether to include pending invoice items (e.g., prorations)
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    pending_invoice_items_behavior: "include" as any,
    metadata: {
